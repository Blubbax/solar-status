# pip3 install configparser ö psycopg2-binary pyserial_asyncio pyserial
...
def readData(inverter_ip, inverter_port):  
    try:
        ...
        #print (datetime.now().strftime("%d/%m/%Y %H:%M:%S") + " battery (W): ", powerToBattery)
